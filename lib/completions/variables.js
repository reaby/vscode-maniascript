...
const { findTypesInContext, getClassPropTypes } = require("./classes.js");
const { getStructElemType } = require("./structs.js");
...
function parseforeach(matchText, context) {
  ...
  if (Array.isArray(mArray) && mArray.length === 4) {
    ...
    type = resolveVarible(type, context) || type;
    variablesTypes[variablesNames.lastIndexOf(name)] = type;
